...
import {
	UseCasesSimpleBarChartMultiplesComposition,
	useCasesSimpleBarChartMultiplesCompositionSchema,
} from './compositions/POCs/NewBarCharts/DynamicList/UseCasesSimpleBarChartMultiplesComposition';

import {
	UseCasesSimpleBarChartComposedComposition,
	useCasesSimpleBarChartComposedCompositionSchema,
} from './compositions/POCs/NewBarCharts/DynamicList/UseCasesSimpleBarChartComposedComposition';

import {
	UseCasesSimpleBarChartCustomComponentsComposition,
		...
		<>
			<Folder name="Production-Flics">
				...
				<Composition
					...
					defaultProps={{
						ticker: 'BTC-USD' as const,
						strategyTicker: 'BITCOIN_GOLD_VOLA_BALANCED_360' as const,
						timePeriod: '2Y' as const,
						nerdyFinanceEnv: 'DEV' as const,
						theme: 'LORENZOBERTOLINI_BRIGHT' as const,
						chartTheme: 'LORENZOBERTOLINI' as const,
			...
			<Folder name="POCs">
				...
				<Folder name="09-Timeseries">
					<Composition
						...
						defaultProps={{
							firstDate: new Date('2020-01-01T11:36:55.563Z'),
				...
				<Folder name="New-BarCharts">
					...
					<Composition
						// You can take the "id" to render a video:
						// npx remotion render src/index.ts <id> out/video.mp4
						id="BarChartAnimation"
						component={BarChartAnimationComposition}
					...
					<Composition
						// You can take the "id" to render a video:
						// npx remotion render src/index.ts <id> out/video.mp4
						id="UseCases-SimpleBarChart-Composed"
						component={UseCasesSimpleBarChartComposedComposition}
						durationInFrames={30 * 30}
						fps={30}
						{...videoSizes.widescreen_16x9}
						schema={useCasesSimpleBarChartComposedCompositionSchema}
						defaultProps={{themeEnum: 'LORENZOBERTOLINI' as const}}
					/>
					<Composition
						// You can take the "id" to render a video:
						// npx remotion render src/index.ts <id> out/video.mp4
						id="UseCases-BarChart-CustomComponents"
						component={UseCasesSimpleBarChartCustomComponentsComposition}
						durationInFrames={30 * 30}
						fps={30}
						{...videoSizes.widescreen_16x9}
